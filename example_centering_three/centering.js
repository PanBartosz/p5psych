...
function setup() {
    if (window.location['host'] == 'kognilab.pl'){
        var url = 'http://kognilab.pl/p5psych/cb/centeringt/6';
    } else {
        var url = 'http://localhost:5000/cb/centeringt/6';
    }
...
function setupExp(){
    ...
    var displaySentence0_train = new Routine();
    ...
    var f0_train = new TextStimulus({name : 'f0train', text: function() {return training_loop.currentTrial['F0'];}});
    ...
    var response0_train = new KeyboardResponse({name : 'sentence_response_training'});
    ...
    var response_sensible_train = new KeyboardResponse({name: 'response_sensible', keys: [81, 69]});
    ...
    displaySentence0_train.addComponent(f0_train);
    displaySentence0_train.addComponent(response0_train);
    ...
    var displaySentence0 = new Routine();

    f0 = new TextStimulus({name : 'f0', text: function() {return trials.currentTrial['F0'];}});
    var response0 = new KeyboardResponse({name : 'sentence_response'});

    displaySentence0.addComponent(f0);
    displaySentence0.addComponent(response0);
    ...
    var response_sensible = new KeyboardResponse({name: 'response_sensible', keys: [81, 69]});
    ...
    training_loop.addRoutine(displaySentence0_train);
    ...
    trials.addRoutine(displaySentence0);
